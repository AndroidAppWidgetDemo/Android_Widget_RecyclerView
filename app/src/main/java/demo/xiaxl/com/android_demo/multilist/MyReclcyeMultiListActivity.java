 ...
 *
 */
public class MyReclcyeMultiListActivity extends Activity {
    ...
    // adapter
    private MyRecycleMultiListAdapter mMyadapter = null;
    /**
     * 数据
     */
    //data
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recycle_multilist_activity);
    ...
    public void initUI() {
         ...
         */
        // 创建Adapter，并指定数据集
        mMyadapter = new MyRecycleMultiListAdapter(mDataList);
        // 设置Adapter
